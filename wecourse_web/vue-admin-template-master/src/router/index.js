...
export const constantRouterMap = [
...

  {
    ...
    children: [
      ...
      {
        path: 'edit/:id',  //:id表示占位符，需要在edit/后面跟上id
        name: '编辑讲师',
        component: () => import('@/views/edu/teacher/save'),
...

  {
    ...
    children: [
      {
        path: 'https://element.eleme.cn/2.5/#/zh-CN/component/installation',
